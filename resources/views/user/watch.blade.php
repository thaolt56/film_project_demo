    ...
    <div class="row container" id="wrapper">
       <div class="halim-panel-filter">
          <div class="panel-heading">
             <div class="row">
                <div class="col-xs-6">
                  <div class="yoast_breadcrumb hidden-xs"><span><span><a href="danhmuc.php">{{$movie_watch->category_show->title}}</a> » <span><a href="danhmuc.php">{{$movie_watch->country_show->title}}</a> » <span class="breadcrumb_last" aria-current="page">{{$movie_watch->title}}</span></span></span></span></div>
                </div>
             </div>
          </div>
       ...
       <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
             ...
             <div class="clearfix wrap-content">
                ...
                <div class="title-block">
                   ...
                   <div class="title-wrapper-xem full">
                      <h1 class="entry-title"><a href="" title="Tôi Và Chúng Ta Ở Bên Nhau" class="tl">{{$movie_watch->title}}</a></h1>
                   </div>
                </div>
                         ...
                         <div class="halim-server">
                            <ul class="halim-list-eps">
                              ...
                              <li class="halim-episode">
                                 <a href="{{url('xem-phim/'.$movie_watch->slug.'/tap-'.$episode->season)}}"><span class="halim-btn halim-btn-2 {{$e==$episode->season?'active':''}} halim-info-1-1 box-shadow" data-post-id="37976" data-server="1" data-episode="1" data-position="first" data-embed="0" data-title="Xem phim Tôi Và Chúng Ta Ở Bên Nhau - Tập 1 - Be Together - vietsub + Thuyết Minh" data-h1="Tôi Và Chúng Ta Ở Bên Nhau - tập 1">{{$episode->season}}</span></a>
                              </li>
                              @endforeach
         ...
         {{-- @if (!empty($list_related))
             @foreach ($list_related as $movie)
             <article class="thumb grid-item post-38494">
               <div class="halim-item">
               <a class="halim-thumb" href="chitiet.php" title="Câu Chuyện Kinh Dị Cổ Điển">
               <figure><img class="lazy img-responsive" src="{{asset($movie->movie_image)}}" alt="Câu Chuyện Kinh Dị Cổ Điển" title="Câu Chuyện Kinh Dị Cổ Điển"></figure>
